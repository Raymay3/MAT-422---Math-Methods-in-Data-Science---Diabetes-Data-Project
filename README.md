...
• Processed and analyzed a dataset of 520 observations and 16 clinical features, performing data 
preprocessing, categorical encoding, and feature scaling 

• Applied Recursive Feature Elimination (RFE) and statistical analysis (correlation, chi-square, t-tests) 
to identify key predictors 

• Evaluated model performance using accuracy, precision, recall, F1-score, and AUC-ROC, achieving 
